...
public interface SongService extends IService<Song> {
    ...
    R songOfIntroduction(String introduction);

    R updateSongClickCount(Integer id);

    R updateSongCollectionCount(Integer id);

    R updateSongCommentCount(Integer id);

    R rankSongByClickCount();

    R rankSongByCollectionCount();

    R rankSongByCommentCount();
}
