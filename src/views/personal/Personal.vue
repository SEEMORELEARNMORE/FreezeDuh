<template>
  <div class="personal">
    ...
    <div class="personal-info">
      <el-image class="personal-img" fit="conver" :src="attachImageUrl(userPic)" @click="dialogTableVisible = true" />
    ...
    <div class="personal-collection">
      <h2>我的收藏</h2>
      <img src="@/assets/images/empty.png" alt="" v-if="!collectSongList.length">
    <div class="personal-body" v-if="collectSongList.length">
...
export default defineComponent({
  ...
  setup() {
    ...
    function goPage() {
      if(!checkStatus()) {routerManager(RouterName.Home, { path: RouterName.Home }); return} 
...
.personal {
  ...
  // &::before {
  //   content: "";
  //   background: url(@/assets/images/personal-bg.jfif) no-repeat;
  //   object-fit: contain;
  //   width: 100%;
  //   position: absolute;
  //   top: 0;
